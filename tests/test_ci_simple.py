"""
Simplified CI test configuration with in-memory database
"""
import pytest
import os
...
def test_ci_checkmate_detection(ci_client):
    ...
    # In a real test, we'd set up a checkmate position
    # For now, just verify the game exists and is playable
